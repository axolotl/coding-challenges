...
//   if (divided[i] === '+') {
//     result += parseInt(divided[i + 1])
//   } else {
//     result -= parseInt(divided[i + 1])
//   }

//   allFrequencies.push(result)
// }

// for (let i = 0; i < allFrequencies.length; i++) {
//   console.log(allFrequencies.slice(0, i).length)
//   if (allFrequencies.slice(0, i).includes(allFrequencies[i])) {
//     console.log(allFrequencies[i])
//     break
//   }
// }

for (let i = 0; ; i = i === divided.length - 2 ? 0 : i + 2) {
  if (divided[i] === '+') {
    result += parseInt(divided[i + 1])
  } else {
    result -= parseInt(divided[i + 1])
  ...
  console.log(result)
  if (allFrequencies.includes(result)) {
